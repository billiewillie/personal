import { Instagram, Github, AtSign } from 'lucide-react'
				...
				<div className="container">
					<div className="flex items-center flex-col rounded-3xl bg-black-800 py-12 gap-y-8 shadow">
						<div data-aos="fade"
							...
							<div className="flex items-center leading-none gap-2 rounded-full bg-[#B5FF6D]/10 px-4 py-2">
								...
								<p className="text-xs text-text-primary">Открыт для предложений</p>
							</div>
						</div>
						<div data-aos="fade"
								 data-aos-offset="0"
